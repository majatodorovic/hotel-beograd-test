...
export default function Footer({ data, lang }: any) {
  ...
  return (
    <footer
      ...
      data-aos-once="true"
      className="w-full flex flex-col items-center px-6 md:px-7 bg-red-800 pt-11 text-white overflow-hidden"
    >
      <div className="flex w-full max-w-[1612px] flex-col items-center">
        <Link href={"/"} prefetch={false}>
          ...
          >
            <Image
              ...
              width={234}
              height={171}
              className="max-w-48 md:max-w-56 w-full mb-10 md:mb-16"
            />
          </div>
        </Link>
        ...
        >
          © {currentYear} Hotel Beograd | {data.copyright} Powered by{" "}
          <a
            className="underline"
